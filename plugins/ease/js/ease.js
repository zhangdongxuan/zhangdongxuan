 ...
 *
 * @author <a href="mailto:LLY219@gmail.com" target="_blank" rel="noopener">Liyuan Li</a>
    ...
    scrollEvent: function () {
        ...
        $(window).scroll(function () {
            ...
            if (y > _it.headerH) {
                ...
                var top =  y + bodyH - 21;
                if ($("body").height() - 58 <= y + bodyh) { top="$(".footer").offset().top" - 21; } $("#gotop").fadein("slow").css("top", top); else $("#gotop").hide(); }); }, setdynamic: function () var $dynamic="$(".dynamic");" if ($(".dynamic").length < 1) return; $comments="$dynamic.find(".side-comments")," $tags="$dynamic.find(".side-tags")," $mostcomment="$dynamic.find(".side-most-comment")," $mostview="$dynamic.find(".side-most-view");" ($comments.height()> $tags.height()) {
